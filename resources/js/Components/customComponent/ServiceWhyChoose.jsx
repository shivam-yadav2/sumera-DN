    ...
    const defaultFeatures = [
        {
            ...
            description:
                "Our certified experts bring years of experience and passion to deliver exceptional results every time.",
        },
        {
            icon: Sparkles,
            title: "Premium Products",
            description:
                "We use only the finest, internationally acclaimed products that are gentle yet effective.",
        },
        {
            icon: Heart,
            title: "Personalized Care",
            description:
                "Every service is customized to your unique needs, preferences, and beauty goals.",
        },
        {
            icon: Shield,
            title: "Hygiene & Safety",
            description:
                "Maintaining the highest standards of cleanliness and safety for your peace of mind.",
        },
        {
            icon: Clock,
            title: "Flexible Timing",
            description:
                "Convenient appointment slots that fit your busy schedule, including weekends.",
        },
        {
            icon: Users,
            title: "Customer Satisfaction",
            description:
                "1000+ happy clients trust us for their beauty needs and transformations.",
        },
    ];
                    ...
                    <div className="relative z-10 grid md:grid-cols-[minmax(0,2fr)_minmax(0,1fr)] gap-12 items-center">
                        <div>
                            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur mb-6">
                                ...
                                <span className="text-xs uppercase tracking-wider text-[#e7d3ba]">
                                    What You Get
                                </span>
                            </div>
                            ...
                            <p className="text-white/70 text-lg mb-8 leading-relaxed">
                                When you choose Sumeera, you're choosing
                                excellence, care, and a commitment to bringing
                                out your best self.
                            </p>
                                ...
                                <div className="relative bg-white/10 backdrop-blur-sm rounded-3xl border border-white/20 p-8 text-center">
                                    <div className="space-y-6">
                                        <div className="p-6 bg-white/10 rounded-2xl backdrop-blur">
                                            <div className="text-5xl font-[600] text-white mb-2 head">
                                                1000+
                                            </div>
