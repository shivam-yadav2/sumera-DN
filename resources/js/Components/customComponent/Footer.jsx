                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
                    ...
                    <div className="space-y-6">
                        <div className="flex items-center gap-2 mb-6">
                            <div className="text-3xl font-bold text-white head">
                                Salon
                            </div>
                        </div>
                        <p className="text-gray-400 text-sm leading-relaxed">
                            Lorem ipsum dolor sit amet, consectetur adip iscing
                            elit, sed do eiusmod temporin cididunt ut labore et
                            dolore magna aliqua. Ut enim ad minim veniam.eiusmod
                            tempo.
                        </p>
                ...
                <div className="max-w-7xl mx-auto px-4 py-6">
                    <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                        ...
                        <div className="flex gap-6">
                            <a
                                href="#"
                                className="text-[#D4A574] hover:text-[#c09566] text-sm transition-colors"
                            >
                                Terms & Condition
                            </a>
