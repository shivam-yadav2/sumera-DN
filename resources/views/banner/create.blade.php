                ...
                <div class="col-12">
                    ...
                    <div id="example-form">
                        <section>
                            ...
                            <form method="post" action="{{ url('/add-banner') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="row ">
                                    <div class="col-md-12">
                                        <div class="row gutters">
                                                ...
                                                <div class="card-body row">
                                                    ...
                                                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12">
                                                        <div class="form-group mb-2">
                                                            ...
                                                            <input type="text" class="form-control" name="url" placeholder="Banner Target URL" />
                                                        </div>
                                                    </div>
                                                    <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-12">
                                                        <label>Select Banner Service <span class="text-danger">*</span></label>
                                                        <div class="form-group mb-2">
                                                    ...
                                                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12">
                                                        <div class="form-group mb-2">
                                                            <label for="Slider_image">Slider Image 1920*650 Max=500KB</label><br>
                                                    ...
                                                    <div class="col-md-12 text-center mt-3">
                                                        <button type="submit" class="btn btn-md btn-primary">Submit Banner</button>
                                                    </div>
