                ...
                <div class="col-12">
                    ...
                    <div id="example-form">
                        <section>
                            ...
                            <form method="post" action="{{ url('/add-package') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="row ">
                                    <div class="col-md-12">
                                        <div class="row gutters">
                                            <div class="card">
                                                ...
                                                <div class="card-body row">
                                                    ...
                                                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12">
                                                        <div class="form-group mb-2">
                                                            <label for="Slider_image">Slider Image 500*500 Max=90KB</label><br>
                ...
                $(document).on('click', ".confirmDelete", function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            window.location.href = "/delete-package/" + id;
                        }
                    });
                });
            </script>
